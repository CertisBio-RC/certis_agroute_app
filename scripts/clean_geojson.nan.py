...
Problem:
  Some of the pipeline steps (pandas -> json) can leave literal NaN values in
  ...
  This is NOT valid JSON and causes the browser to throw:
...
Solution:
  This utility:
    ...
    • Recursively walks the object and replaces any float('nan') with ""
      (empty string; you can change to None if you prefer null)
