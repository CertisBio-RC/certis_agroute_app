...
export default function CertisMap({
  ...
  const geojsonPath = `${basePath}/data/retailers.geojson?v=20251021f`;
    ...
    map.on("load", async () => {
      try {
        ...
        map.on("click", ["retailers-layer", "kingpins-layer"], (e) => {
          ...
          const suppliers =
            suppliersArr.length > 0 ? suppliersArr.join(", ") : "N/A";
